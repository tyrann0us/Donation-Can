...
class DonationCanPayPalIPN extends DonationCanPaymentMethod {
    ...
    function convertStatusCodeToStatus($status) {
        ...
        /*
         * The status of the payment: (copied from PayPal's documentation)
         *
         * Canceled_Reversal:
         * A reversal has been canceled. For example, you won a dispute
         * with the customer, and the funds for the transaction that was
