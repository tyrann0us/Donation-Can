...
?>
<?php
    $goal_name = __("Donations to all goals", "donation-can");
    if ($filter_goal) {
        $selected_goal = $goals[$filter_goal];
        $goal_name = "Donations to \"" . $selected_goal["name"] . "\"";
    }
?>
...
<div class="wrap">
	...
	<form method="post" name="filter_donations" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
            ...
            <div class="tablenav-pages">
                <?php $url =  get_bloginfo("url") . "/wp-admin/admin.php?page=donations.php"; ?>
