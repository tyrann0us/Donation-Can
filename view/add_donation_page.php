                ...
                <div id="post-body-content">
                    <div class="stuffbox">
                        ...
                        <div class="inside" id="goal-id-div">
                            ...
                            <p>
                                <?php _e('Select the goal to add the donation to.', "donation_can");?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="stuffbox">
                        <h3><label for="payer_name"><?php _e("Name of donor", "donation_can");?></label></h3>
                    ...
                    <div class="stuffbox">
                        <h3><label for="payer_email"><?php _e("Email address of donor", "donation_can");?></label></h3>
                        <div class="inside" id="payer_email-div">
                            <input type="text" name="payer_email" value="<?php echo $payer_email; ?>" size="30"/>
                        </div>
                    </div>

                    <div class="stuffbox">
                        <h3><label for="note"><?php _e("Note", "donation_can");?></label></h3>
