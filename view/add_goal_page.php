...
<div class="wrap">
	<h2><?php _e("Add New Donation Goal", "donation_can"); ?></h2>
							...
							<div class="submitbox" id="submitlink">
								...
								<div id="major-publishing-actions">
									...
									<div id="publishing-action">
										<input type="submit" class="button-primary" id="publish" value="<?php _e("Add Goal", "donation_can");?>"/>
									</div>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>	
					...
					<div class="stuffbox">
						...
						<div class="inside" id="thank-you-page-id-div">
							<select name="return_page">
								<option value="-1">-- <?php _e("Use PayPal Default", "donation_can");?> --</option>
