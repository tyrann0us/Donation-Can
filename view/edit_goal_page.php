							...
							<div class="submitbox" id="submitlink">
								...
								<div id="major-publishing-actions">
									...
									<div id="publishing-action">
										<input type="submit" class="button-primary" id="publish" value="Save Changes"/>
									</div>
									<div class="clear"></div>
								</div>
								<div class="clear"></div>	
					...
					<div class="stuffbox">
						...
						<div class="inside" id="thank-you-page-id-div">
							<select name="return_page">
								<option value="-1" <?php if ("-1" == $goal["return_page"]) { echo "selected"; }?>>-- Use Plugin Default --</option>
					...
					<div class="stuffbox">
						...
						<div class="inside" id="cancelled-page-id-div">
							<select name="cancelled_return_page">
								<option value="-1" <?php if ("-1" == $goal["cancelled_return_page"]) { echo "selected"; }?>>-- Use Plugin Default --</option>
								<?php foreach ($pages as $page) : ?>
